	...
	public class BindUnityUI {
		public static Action<IntPtr>[] GetBindList() {
			Action<IntPtr>[] list= {
				...
				Lua_UnityEngine_EventSystems_EventSystemManager.reg,
				...
				Lua_UnityEngine_UI_InputField_Validation.reg,
				...
				Lua_UnityEngine_UI_PhysicalResolution.reg,
				Lua_UnityEngine_UI_PhysicalResolution_Unit.reg,
				Lua_UnityEngine_UI_ReferenceResolution.reg,
