...
//	[HideInInspector]
	...
	void Start () {
		...
		attackEvent.time = _anims ["mdldecompiler.qc_skeleton|attack_main"].length * 2 / 3;
		attackEvent.functionName = "onAttackFinished";
		_anims ["mdldecompiler.qc_skeleton|attack_main"].clip.AddEvent ( attackEvent );
	}
...
//		anim.Play ("attack_normal");
		_anims ["mdldecompiler.qc_skeleton|attack_main"].speed = _anims ["mdldecompiler.qc_skeleton|attack_main"].length * (1 + AttackSpeed / 100) / BasicBetween;
		//_anims ["mdldecompiler.qc_skeleton|attack_main"].clip.AddEvent( new AnimationEvent());
...
//		_anims ["mdldecompiler.qc_skeleton|run"].clip.a
