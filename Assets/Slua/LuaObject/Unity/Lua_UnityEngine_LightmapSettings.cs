...
public class Lua_UnityEngine_LightmapSettings : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_lightmapsModeLegacy(IntPtr l) {
		try {
			pushValue(l,true);
			pushEnum(l,(int)UnityEngine.LightmapSettings.lightmapsModeLegacy);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int set_lightmapsModeLegacy(IntPtr l) {
		try {
			UnityEngine.LightmapsModeLegacy v;
			checkEnum(l,2,out v);
			UnityEngine.LightmapSettings.lightmapsModeLegacy=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"lightmapsModeLegacy",get_lightmapsModeLegacy,set_lightmapsModeLegacy,false);
