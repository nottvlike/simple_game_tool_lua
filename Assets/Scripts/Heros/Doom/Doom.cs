...
public class Doom : MonoBehaviour {
	...
	private Doom_Animation hero_animation;
	private Doom_Collider hero_collider;
	private Collision hitCollider = null;
	private int state = 0;

	void Awake()
	{
		hero_animation = _anim.GetComponent<Doom_Animation> ();
		hero_collider = _coll.GetComponent<Doom_Collider> ();
	}
